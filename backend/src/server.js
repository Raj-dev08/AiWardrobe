...
//   try {
//     const response = await axios.get(AI_HELPER_API_KEY + "/health", timeout - );
//     res.status(200).json({ message: "AI Helper is healthy", data: response.data , success: true});
//   } catch (error) {
//     res.status(500).json({ message: "AI Helper is not healthy", success: false });
//   }
// })
